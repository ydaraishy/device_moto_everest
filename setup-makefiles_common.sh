...
\$(call inherit-product-if-exists, vendor/__MANUFACTURER__/__DEVICE__/device-vendor-blobs_ril.mk)
\$(call inherit-product-if-exists, vendor/__MANUFACTURER__/__DEVICE__/device-vendor-blobs_drivers.mk)
\$(call inherit-product-if-exists, vendor/__MANUFACTURER__/__DEVICE__/device-vendor-blobs_bootanimation.mk)
EOF
